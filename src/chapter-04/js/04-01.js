function init() {
  ...
  const groundGeom = new THREE.PlaneBufferGeometry(100, 100, 4, 4);
  ...
  const sphereGeometry = new THREE.SphereBufferGeometry(14, 20, 20);
  const cubeGeometry = new THREE.BoxBufferGeometry(15, 15, 15);
  const planeGeometry = new THREE.PlaneBufferGeometry(14, 14, 4, 4);
