...
function init() {
  ...
  const fontload1 = new THREE.FontLoader();
  fontload1.load(
  ...
  const fontload2 = new THREE.FontLoader();
  fontload2.load('../../assets/fonts/helvetiker_bold.typeface.json', function (
    response
  ) {
    font_helvetiker_bold = response;
  });

  const fontload3 = new THREE.FontLoader();
  fontload3.load(
