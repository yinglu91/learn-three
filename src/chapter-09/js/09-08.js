function init() {
  ...
  const controls = {
    ...
    warp: function () {
      clipAction.warp(
        controls.warpStartTimeScale,
        controls.warpEndTimeScale,
        controls.warpDurationInSeconds
      );
    },
  ...
  function enableControls() {
    ...
    actionFolder
      .add(controls, "repetitions", 0, 100)
      .listen()
      .onChange(function (e) {
        if (
    ...
    actionFolder
      .add(clipAction, "time", 0, animationClip.duration, 0.001)
      .listen();
