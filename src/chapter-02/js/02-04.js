function init() {
  ...
  function addGeometries(scene) {
    ...
    // basic cube
    geoms.push(new THREE.BoxBufferGeometry(2, 2, 2));

    // basic spherer
    geoms.push(new THREE.SphereBufferGeometry(2));
    ...
    geoms.push(new THREE.ConvexBufferGeometry(points));
    ...
    geoms.push(new THREE.LatheBufferGeometry(pts, 12));

    // create a OctahedronGeometry
    geoms.push(new THREE.OctahedronBufferGeometry(3));
    ...
    //
    geoms.push(new THREE.TetrahedronBufferGeometry(3));

    geoms.push(new THREE.TorusBufferGeometry(3, 1, 10, 10));

    geoms.push(new THREE.TorusKnotBufferGeometry(3, 0.5, 50, 20));
